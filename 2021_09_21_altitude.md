...
```
getwd()
setwd("/home/user/Área de Trabalho/Bio/projeto_publ/2020_altitude") #Mudança de diretório para pasta do projeto
```
...
caminho.do.arquivo <- "/home/user/Área de Trabalho/Bio/projeto_publ/2020_altitude/gradientealt.xlsx"
...
Agora o gŕafico.
```
ggplot(Date, aes(x = Date, y = Species, colour = Locality)) + 
...
```
dicalt <- lm(p2$Altitude ~ planilhatotal$Species, data = planilhatotal) 
anova(dicalt) 
```
...
Agora vamos ver um gráfico marginal, vamos de pacotes:
```
